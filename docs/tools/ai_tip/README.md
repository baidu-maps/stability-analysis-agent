...
CLI 将上述最终提示词通过 `TOOL_OUTPUT:ai_prompt:` 或 `TOOL_OUTPUT:ai_analysis:` 输出，并写入报告目录下按轮次子目录 **round_N/05_ai_final_tip.txt**（单轮为 round_0，多轮为 round_0、round_1、…）。详见 `doc/cli_reports/README.md`。
