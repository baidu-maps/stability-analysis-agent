...
<p align="center">
  <sub>
    ...
    <b>latest:</b> <a href="https://pypi.org/project/stability-analysis-agent/1.3.5/">v1.3.5</a>
    (CentOS 7 SQLite metadata, remote POST /runs guards, HTTP apply_ai_fixes default false) ·
